            ...
            <?php foreach ($itens_carrinho as $item): ?>
                <div class="info-container produto_container">
                    <div class="div-produto_info">
                        <a href="detalhes-produto.php?id=<?= $item['id_produto']; ?>" class="div-produto_info_img">
                    ...
                    <div class="div-produto_opcoes">
                        <div class="mt-3" style="max-width: 225px;">
                            <div class="input-group input-group-sm"
                                style="background: rgba(128, 128, 128, 0.231); border-radius: 0.5rem;">
        ...
        <div class="coluna-2">
            <div class="info-container">
                <div class="div-valor_info px-3 pt-3">
                    <h5>Subtotal (<?= count($itens_carrinho); ?> itens):</h5>
