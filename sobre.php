...
<head>
    ...
    <link rel="stylesheet" href="recursos/css/sobre.css" />
...
<body>
    ...
    <main class="main-sobre">
        <div class="div-sobre_conteudo">
            ...
            <p class="sobre-texto">
                A <strong style="font-family: 'Josefin Sans', sans-serif; color: #ff4400">FUTUREMOB</strong> tem o desejo de promover elegância, conforto e tecnologia por meio de nossos produtos, oferecendo uma experiência exclusiva e 
                diferenciada.
            </p>
        </div>
        <div class="div-sobre_conteudo">
