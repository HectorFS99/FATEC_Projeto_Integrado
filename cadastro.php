	...
	<main class="container">
		<form id="formCadastro" method="post" name="Diogao" class="formulario w-100" onsubmit="document.Diogao.action='cadastrar.php'">	
			...
			<div class="form-floating m-1">
				<input onfocusout="validarCampo('txtNome', 'txtNomeErro');" id="txtNome" type="text" class="form-control" placeholder="Nome completo" name="txt_nome" required>
			...
			<div class="d-flex flex-wrap">
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('dtNasc', 'dtNascErro');" id="dtNasc" type="date" class="form-control" min="1900-01-01" max="2024-01-01" name="date" required>
					<label for="dtNasc">Data de nascimento</label>
					<div id="dtNascErro" class="invalid-feedback">
					</div>
				</div>
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtCPF', 'txtCPFerro');" oninput="aplicarMascaraCPF(this);" id="txtCPF" type="text" maxlength="14" class="form-control" placeholder="CPF" name="txt_cpf" required>
					<label for="txtCPF">CPF</label>
					<div id="txtCPFerro" class="invalid-feedback">
					</div>
				</div>
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtRG', 'txtRGerro');" oninput="aplicarMascaraRG(this);" id="txtRG" type="text" maxlength="12" class="form-control" placeholder="RG" name="txt_rg" required>
			...
			<div class="d-flex flex-wrap">
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtTelefone', 'txtTelefoneErro');" oninput="aplicarMascaraTelefone(this);" id="txtTelefone" type="tel" class="form-control" placeholder="Telefone" name="txt_telefone" required>
					<label for="txtTelefone">Celular com DDD</label>
					<div id="txtTelefoneErro" class="invalid-feedback">
					</div>
				</div>
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtEmail', 'txtEmailErro');" id="txtEmail" type="email" class="form-control" placeholder="E-mail" name="txt_email" required>
					<label for="txtEmail">E-mail</label>
					<div id="txtEmailErro" class="invalid-feedback">
					</div>
				</div>
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtConfirmarEmail', 'txtConfirmarEmailErro');" id="txtConfirmarEmail" type="email" class="form-control" placeholder="Confirmar e-mail" autocomplete="off" name="txt_confirmar_email" required>
			...
			<div class="d-flex flex-wrap">
				<div class="flex-fill flex-sm-fill m-1">
					<div class="form-floating ">
						<input onfocusout="validarCampo('txtSenha', 'txtSenhaErro');" id="txtSenha" type="password" class="form-control" placeholder="Senha" name="txt_senha" required>
				...
				<div class="form-floating flex-fill m-1">
					<input onfocusout="validarCampo('txtConfirmarSenha', 'txtConfirmarSenhaErro');" id="txtConfirmarSenha" type="password" class="form-control" placeholder="Confirmar senha" name="txt_confirmar_senha" required>
